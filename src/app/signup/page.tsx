            ...
            <div className="glass-panel p-8 rounded-2xl shadow-2xl w-full max-w-md border border-slate-800 backdrop-blur-xl relative z-10 transition-all hover:shadow-[0_0_30px_rgba(59,130,246,0.1)]">
                ...
                <div className="mb-6">
                    ...
                    >
                        ...
                        {googleLoading ? '...' : t('signupPage.googleSignup')}
                    </button>
                    <div className="relative my-6">
                        <div className="absolute inset-0 flex items-center"><div className="w-full border-t border-slate-700"></div></div>
                        <div className="relative flex justify-center text-xs uppercase"><span className="bg-[#0a0a0f] px-2 text-slate-500">{t('signupPage.orRegisterWithEmail')}</span></div>
                    </div>
                </div>
