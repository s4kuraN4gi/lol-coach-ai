    ...
    return (
        <div className="relative" ref={ref}>
            <button
                ...
                className="flex items-center gap-2 px-3 py-2 rounded-lg bg-slate-800 border border-slate-700 hover:border-primary/50 transition text-sm text-slate-300 hover:text-white"
            >
            ...
            {/* Dropdown */}
            {open && (
                <div className="absolute top-full right-0 mt-1 bg-slate-900 border border-slate-700 rounded-lg shadow-xl z-50 min-w-[140px]">
                    {LANGUAGES.map((lang) => (
                        <button
                            key={lang.code}
